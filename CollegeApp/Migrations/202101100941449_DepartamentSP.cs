    ...
    public partial class DepartamentSP : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[Department]([Name], [Budget], [StartDate], [ProfesorID])
                      VALUES (@Name, @Budget, @StartDate, @ProfesorID)
            ...
            CreateStoredProcedure(
                ...
                body:
                    @"UPDATE [dbo].[Department]
                      SET [Name] = @Name, [Budget] = @Budget, [StartDate] = @StartDate, [ProfesorID] = @ProfesorID
